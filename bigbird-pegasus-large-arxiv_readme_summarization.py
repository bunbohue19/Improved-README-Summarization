...
from transformers import AutoTokenizer, DataCollatorForSeq2Seq, BigBirdPegasusForConditionalGeneration, Seq2SeqTrainingArguments, Seq2SeqTrainer, BitsAndBytesConfig
...
if __name__ == '__main__':
    ...
    model = BigBirdPegasusForConditionalGeneration.from_pretrained(checkpoint, attention_type="original_full")
    # model = BigBirdPegasusForConditionalGeneration.from_pretrained(checkpoint, quantization_config=bnb_config, attention_type="original_full")
    ...
    training_args = Seq2SeqTrainingArguments(
        output_dir="bigbird-pegasus-large-arxiv_readme_summarization",
